...
<section class="exampapers-hero">
	<div class="exampapers-section-inner">
		...
		<p class="exampapers-lede"><?php esc_html_e( 'Download printable PDF packs by exam region, subject and level.', 'exampapers' ); ?></p>
		...
		<form class="exampapers-search-panel" role="search" method="get" action="<?php echo esc_url( function_exists( 'wc_get_page_id' ) ? get_permalink( wc_get_page_id( 'shop' ) ) : home_url( '/shop/' ) ); ?>" data-exampapers-dependent-filters>
			<label><?php esc_html_e( 'Search by school, exam region or subject', 'exampapers' ); ?></label>
			<div class="exampapers-search-panel__row">
				<?php
				if ( function_exists( 'exampapers_render_product_filter_dropdowns' ) ) {
					exampapers_render_product_filter_dropdowns( 'exampapers-home', array(), false, false );
				}
				?>
		...
		<div class="exampapers-actions">
			...
			<a class="wp-element-button is-style-outline" href="/csse-essex-11-plus-practice-papers/"><?php esc_html_e( 'Find My Exam Region', 'exampapers' ); ?></a>
