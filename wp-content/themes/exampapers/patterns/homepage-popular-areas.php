...
<section class="exampapers-page-section exampapers-section-white">
	<div class="exampapers-section-inner">
		<h2><?php esc_html_e( 'Choose your 11+ region', 'exampapers' ); ?></h2>
		<p><?php esc_html_e( 'Go straight to papers for the exam region your child is preparing for.', 'exampapers' ); ?></p>
		<nav class="exampapers-feature-grid exampapers-area-grid" aria-label="<?php esc_attr_e( 'Popular 11+ regions', 'exampapers' ); ?>">
			<?php foreach ( $area_terms as $term ) : ?>
				...
				$link = add_query_arg(
					array(
						'exam_level'  => '11-practice-papers',
						'exam_region' => $term->slug,
					),
